                        ...
                        <>
                          <div className="chat_people" onClick={() => getChat(item._id)} key={index}>
                            ...
                            <div className="chat_ib">
                              ...
                              <p> {item.chat[item.chat.length - 1].userID_chat === Cookies.get("userID") ?  `Bạn: ${item.chat[item.chat.length - 1].chat_content}` : item.chat[item.chat.length - 1].chat_content}</p>
                            </div>
                          </div>
                        </>
                      );
