...
const CreateReportTemplateForAdmin = () => {
    ...
    async function createReportTemplate(){
        ...
        let response = await axios.post("http://localhost:5000/admin/create-report-template" , body , {headers : {
...
export default CreateReportTemplateForAdmin;
