                                    ...
                                    <div className="col-md-10">
                                        ...
                                        {report.reportComment.map(i2 => 
                                                  ...
                                                  <div className="action d-flex justify-content-between mt-2 align-items-center">
                                                     {i2.userID_Comment === userData._id && <div onClick={() => DeleteCommentReport(i2.createAt_Comment)} className="reply px-4"> <small>Remove</small></div> } 
...
export default ReportDetailForMentor;
