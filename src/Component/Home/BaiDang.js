...
<div className="col-md-6">
    ...
    <div className="Comment border-bottom border-top row">
        <a type="button" className="col-4 text-center Comment-Like p-2"><i class="fa fa-heart-o" aria-hidden="true"></i> Thích</a>
